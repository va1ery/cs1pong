...
HD_PWD='C:/FPGAProjects/CS1/CS1.runs/design_1_rst_clk_wiz_0_50M_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_rst_clk_wiz_0_50M_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_rst_clk_wiz_0_50M_1.tcl
